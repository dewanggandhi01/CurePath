        ...
        >
          ...
          <div className="navbar-content">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <motion.div
                  className="ananda-btn-bg rounded-exempt"
                  animate={{
                    scale: mobileOpen ? [1, 0.9, 1] : [1, 0.9, 1],
                  }}
                  transition={{
                    duration: 0.4,
                    ease: "easeOut",
                ...
                <div className="ananda-btn-icons rounded-exempt">
                  <motion.svg
                    viewBox="0 0 448 512"
                    className="ananda-line"
                    animate={{
                      y: mobileOpen ? -24 : 0,
                      opacity: mobileOpen ? 0 : 1,
                      scale: mobileOpen ? 0.7 : 1,
                    }}
                    transition={{
                      type: "spring",
                      stiffness: 300,
                  ...
                  <motion.svg
                    viewBox="0 0 320 512"
                    className="ananda-close"
                    animate={{
                      y: mobileOpen ? 0 : 24,
                      opacity: mobileOpen ? 1 : 0,
                      scale: mobileOpen ? 1 : 0.7,
                    }}
                    transition={{
                      type: "spring",
                      stiffness: 300,
