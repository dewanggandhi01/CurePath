...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      <div className="hidden lg:flex relative overflow-hidden flex-col justify-center px-16 xl:px-24 bg-gradient-to-br from-[#115C49] to-[#073226]">
      ...
      <div className="flex items-center justify-center p-6 sm:p-10 bg-white">
        ...
        >
          <div className="lg:hidden flex items-center gap-2.5 mb-10">
            ...
            <span className="text-lg font-bold text-gray-900 tracking-tight">CurePath</span>
          </div>

          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight mb-1.5">
            Welcome back
          </h2>
          <p className="text-gray-400 text-[15px] mb-8">Sign in to your account</p>
